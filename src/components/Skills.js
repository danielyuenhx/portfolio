    ...
    return (
        <div className='select-none w-screen h-screen flex flex-col items-center justify-center'>
            <div className='w-9/12'>
                ...
                <div className='flex font-logo font-bold text-5xl justify-center align-middle mb-5'>
                    TECHNICAL <div className="text-outline">&nbsp;SKILLS</div>
                </div>
            </div>
            <div className='w-10/12 h-4/6 flex justify-around font-title'>
                ...
                <div className='w-3/12 flex flex-col items-center p-10'>
                    ...
                    <div className='flex text-center align-middle font-bold text-xl h-1/6 justify-center top-1/2'><p>Web Development</p></div>
